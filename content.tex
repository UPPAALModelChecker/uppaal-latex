...
The {\tt uppaal.sty} package has been developed over many years by publishing papers related to \uppaal.
...
\item[frameround]
\end{description}
There are are many many more options, please see the documentation for \href{https://ctan.org/pkg/listings}{\tt listings.sty} package.
...
\begin{tabular}{@{}l@{ }l@{ }l@{}}
  ...
  Leads-to & {\tt p \textbackslash uppLeadsTo q} & $p \uppLeadsTo q$ \\
  \bottomrule
\end{tabular}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{@{}r|llllll@{}}
    \toprule
    {\bf Macro} & {\bf Normal} & {\bf Lower} & {\bf Upper} & {\bf Title} & {\bf Bold} & {\bf Emphasize} \\
    \midrule
    Uppaal & Uppaal & \MakeLowercase{Uppaal} & \MakeUppercase{Uppaal} & \MakeTitlecase{Uppaal} & {\bf Uppaal} & {\em Uppaal} \\
